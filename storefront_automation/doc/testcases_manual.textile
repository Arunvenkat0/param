...
|FriendsEmailHidden             |Last letters of recipient큦 email address.|
|Message              			|Message on the gift certificate.|
|Amount     					|Amount of the gift certificate.|
|\2<>. **Address information**|
|FirstName            			|Donor큦 first name.|
|LastName						|Donor큦 last name.|
|Address1             			|Donor큦 first address line.|
|Address2              			|Donor큦 second address line.|
...
|Phone      					|Phone number.|
|DonorsEmail            		|Donor큦 email address|
...
bq(information). You also can create your own textile files. The ant script transforms all textile files in the doc folder to HTML files.
