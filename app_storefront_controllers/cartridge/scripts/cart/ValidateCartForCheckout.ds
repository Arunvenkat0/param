 ...
 * @module piplets/ValidateCartForCehckout
 */
...
function validateProductExistence(basket, pdict)
{
	...
	while(plis.hasNext())
	{
		...
		//RAP-2490 : if this pli is marked as an instore item use the store inventory instead of hte default inventory when diabling the cart based on inventory levels
